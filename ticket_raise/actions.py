...
class ActionWebSense(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        print(text_)
        dispatcher.utter_message("Web Sense "+str(text_))
        return []
...
class ActionSoftwareInstallation(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        print(text_)
        dispatcher.utter_message("Software Installation "+str(text_))
        return []
...
class ActionAdminAccess(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        print(text_)
        dispatcher.utter_message("Admin Access "+str(text_))
        return []
...
class ActionRequestForLaptop(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        print(text_)
        dispatcher.utter_message("Laptop "+str(text_))
        return []
...
class ActionHardwareIssue(Action):
    ...
    def run(self, dispatcher, tracker, domain):
        ...
        print(text_)
        dispatcher.utter_message("Hardware Issue "+str(text_))
        return []
